...
export const addPageWrappers = () => {
  // Wrap the content of divs having a data-page-wrapper attribute
  document.querySelectorAll('div[data-page-wrapper]')?.forEach(div => {
    const wrapperName = div.dataset?.pageWrapper;
    if(wrapperName) {
  ...
  script.setAttribute('src','/components/slides-wrapper.js');
